<?php 
$db = JFactory::getDbo();
$db->setQuery("CREATE TABLE IF NOT EXISTS `#__fvn_orders` (
...
$db->setQuery("CREATE TABLE IF NOT EXISTS `#__fvn_invest_package` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
$db->setQuery("CREATE TABLE IF NOT EXISTS `#__fvn_invest_package_daily` (
...
$db->setQuery("CREATE TABLE IF NOT EXISTS `#__fvn_draw_request` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `invest_package_id` varchar(200) NOT NULL,
...
$db->setQuery("CREATE TABLE IF NOT EXISTS `#__fvn_transaction` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `invest_package_id` varchar(200) NOT NULL,
  `user_id`  int(11) NOT NULL,
  `order_id`  int(11) NOT NULL,
